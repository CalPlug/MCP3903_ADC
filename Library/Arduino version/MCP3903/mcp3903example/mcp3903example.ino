...
SPISettings settingsA(1000000, MSBFIRST, SPI_MODE0); //settings for the SPI for the MCP3903 (1MHZ, MSB in first, SPI Mode ) tested initially -- (either 0,0 (Arduino SPI mode 0) or 1,1 (Arduino SPI Mode 3) according to the datasheet are compatable modes)

void setup()
{
    SPI.begin(); //Start SPI
	mcp3903.init(13, 12, 14, 15); // Setings for your Arduino's SPI pins used for interfacing(pinMOSI, pinMISO, pinSPIClock, pinCS)
